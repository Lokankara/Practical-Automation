...
create table if not exists clubs (id bigserial primary key,title varchar not null,description varchar not null,image_url varchar,category_id int8 references categories(id) not null, unique(title, category_id));
