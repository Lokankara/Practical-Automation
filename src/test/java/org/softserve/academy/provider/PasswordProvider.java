...
public class PasswordProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext)  {
        return Stream.of(
                Arguments.of("", "", "",
                        xpaths,
                        List.of(messages.get(0), messages.get(1), messages.get(3), messages.get(4))),
                Arguments.of("", NEW_PASSWORD, "",
                        List.of(xpaths.get(0), xpaths.get(3)),
                        List.of(messages.get(0), messages.get(4))),
                Arguments.of("", "", NEW_PASSWORD,
                        List.of(xpaths.get(0), xpaths.get(1), xpaths.get(2), xpaths.get(3)),
                        List.of(messages.get(0), messages.get(1), messages.get(3), messages.get(6))),
                Arguments.of("", NEW_PASSWORD, NEW_PASSWORD,
                        List.of(xpaths.get(0)),
                        List.of(messages.get(0))),
                Arguments.of("", NEW_PASSWORD, WRONG_PASSWORD,
                        List.of(xpaths.get(0), xpaths.get(3)),
                        List.of(messages.get(0), messages.get(6))),
                Arguments.of(CURRENT, "", "",
                        List.of(xpaths.get(1), xpaths.get(3)),
                        List.of(messages.get(1), messages.get(4))),
                Arguments.of(CURRENT, CURRENT, "",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(3))),
                Arguments.of(CURRENT, "", CURRENT,
                        List.of(xpaths.get(1), xpaths.get(3)),
                        List.of(messages.get(1), messages.get(6))),
                Arguments.of(CURRENT, "Password!", "Password!",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(2))),
                Arguments.of(CURRENT, CURRENT, CURRENT,
                        List.of(xpaths.get(1)),
                        List.of(messages.get(3))),
                Arguments.of(CURRENT, "Password123", "Password123",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(2))),
                Arguments.of(CURRENT, "WithoutNumbers!", "WithoutNumbers!",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(2))),
                Arguments.of(CURRENT, "WithoutSpecial123", "WithoutSpecial123",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(2))),
                Arguments.of(CURRENT, "WithoutSpecial", "WithoutSpecial",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(2))),
                Arguments.of(CURRENT, "withoutuppercase", "withoutuppercase",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(2))),
                Arguments.of(CURRENT, "WITHOUTLOWERCASE", "WITHOUTLOWERCASE",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(2))),
                Arguments.of(CURRENT, "short", "short",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(5))),
                Arguments.of(CURRENT, "1234567890", "1234567890",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(2))),
                Arguments.of(CURRENT, "VeryLongPasswordThatExceeds20Characters", "VeryLongPasswordThatExceeds20Characters",
                        List.of(xpaths.get(1)),
                        List.of(messages.get(5))),
                Arguments.of(CURRENT, NEW_PASSWORD, WRONG_PASSWORD,
