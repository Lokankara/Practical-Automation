...
import com.softserve.edu.teachua.exceptions.NoSuchWebElementException;
...
public abstract class Search {
    ...
    private WebElement searchWebElement(By by) {
        try {
            ...
            String message = String.format(NO_SUCH_ELEMENT, by.toString());
            logger.warn(message);
            throw new NoSuchWebElementException(message, e);
        }
    }
